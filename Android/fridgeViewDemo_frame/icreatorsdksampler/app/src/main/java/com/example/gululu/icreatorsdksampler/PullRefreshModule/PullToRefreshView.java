package com.example.gululu.icreatorsdksampler.PullRefreshModule;
...
import com.example.gululu.icreatorsdksampler.PullRefreshModule.refresh_view.BaseRefreshView;
import com.example.gululu.icreatorsdksampler.PullRefreshModule.refresh_view.BGRefreshView;
import com.example.gululu.icreatorsdksampler.PullRefreshModule.util.Utils;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        ...
        a.recycle();
       /*decelerateInterpolator 动画速率类，先快后慢*/
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_SUN:
                mBaseRefreshView = new BGRefreshView(getContext(), this);
                break;
            default:
