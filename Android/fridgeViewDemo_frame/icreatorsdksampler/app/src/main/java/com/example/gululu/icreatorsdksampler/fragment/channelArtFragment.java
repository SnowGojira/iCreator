...
public class channelArtFragment extends Fragment {
    ...
    private void loadCollection(){
        ...
        /*rlChannel.setOverScrollMode(View.OVER_SCROLL_NEVER);
        rlChannel.setOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
