...
public class HistoryAdapter extends BaseAdapter{
    ...
    public HistoryAdapter(Context context,List<HashMap<String,Object>> list,HistroryDBHelper helper) {
        mContext=context;
        mList=list;
        mHelper=helper;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Log.i("Haku", uid + "/" + dbId);
        /*做一步转码*/
        holder.tvHistory.setText(ConvertStringUtils.convertToName(uid));
        //holder.tvHistoryEng.setText(ConvertStringUtils.translateName(uid));
